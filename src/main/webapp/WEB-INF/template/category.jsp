...
<div class="swiper-container category_list">
    <ul class="swiper-wrapper">
        <li class="swiper-slide"><a href="category">分类</a></li>
        <li class="swiper-slide"><a href="category">横向滚动</a></li>
        <li class="swiper-slide"><a href="category" class="curr_link">当前分类</a></li>
        <li class="swiper-slide"><a href="category">分类</a></li>
        <li class="swiper-slide"><a href="category">玻璃</a></li>
        <li class="swiper-slide"><a href="category">创意</a></li>
        <li class="swiper-slide"><a href="category">设计</a></li>
        <li class="swiper-slide"><a href="category">设计稿</a></li>
        <li class="swiper-slide"><a href="category">测试</a></li>
        <li class="swiper-slide"><a href="category">分类</a></li>
    </ul>
    <!-- Add Pagination -->
